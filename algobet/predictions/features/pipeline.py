...
def prepare_match_dataframe(matches: list[Any]) -> pd.DataFrame:
    ...
    for match in matches:
        record = {
            ...
            "opening_avg_home_odds": match.opening_avg_home_odds,
            "opening_avg_draw_odds": match.opening_avg_draw_odds,
            "opening_avg_away_odds": match.opening_avg_away_odds,
            "closing_avg_home_odds": match.closing_avg_home_odds,
            "closing_avg_draw_odds": match.closing_avg_draw_odds,
            "closing_avg_away_odds": match.closing_avg_away_odds,
            "opening_max_home_odds": match.opening_max_home_odds,
            "opening_max_draw_odds": match.opening_max_draw_odds,
            "opening_max_away_odds": match.opening_max_away_odds,
            "closing_max_home_odds": match.closing_max_home_odds,
            "closing_max_draw_odds": match.closing_max_draw_odds,
            "closing_max_away_odds": match.closing_max_away_odds,
            "opening_asian_handicap": match.opening_asian_handicap,
            "opening_asian_handicap_away": match.opening_asian_handicap_away,
            "opening_asian_handicap_line": match.opening_asian_handicap_line,
            "closing_asian_handicap": match.closing_asian_handicap,
            "closing_asian_handicap_away": match.closing_asian_handicap_away,
            "closing_asian_handicap_line": match.closing_asian_handicap_line,
            "opening_over_under_25": match.opening_over_under_25,
            "opening_over_under_25_under": match.opening_over_under_25_under,
            "opening_over_under_line": match.opening_over_under_line,
            "closing_over_under_25": match.closing_over_under_25,
            "closing_over_under_25_under": match.closing_over_under_25_under,
            "closing_over_under_line": match.closing_over_under_line,
        }
