"""Model management service for ML model version operations.

This module provides business logic for managing ML model versions,
...
class ModelManagementService(BaseService[Session]):
    ...
    def activate_model(self, request: ModelActivateRequest) -> ModelActivateResponse:
        ...
        try:
            ...
            self.session.query(ModelVersion).update(
                {ModelVersion.is_active: False}, synchronize_session="fetch"
            )
    ...
    def get_model_info(self, request: ModelInfoRequest) -> ModelDetailResponse:
