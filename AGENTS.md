...
This document provides essential information for agentic coding agents working with the Algobet frontend repository. It covers build/lint/test commands, code style guidelines, testing patterns, and configuration details.
...
├── src/                          # Main source (legacy/alternative)
