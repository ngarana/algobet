...
class TestServicePerformance:
    ...
    async def test_async_database_service_get_stats_performance(self):
        ...
        mock_session.execute.return_value.scalar.return_value = (
            1000  # Return 1000 for all scalars
        )
    ...
    def test_query_service_list_operations_performance(self):
        ...
        start_time = time.time()
        from algobet.services.dto import TeamFilter, TournamentFilter
...
def test_comparison_sync_vs_async_performance():
    ...
    # This is more of a conceptual test showing how performance
    # could be compared
    ...
    (
        mock_session_sync.query.return_value.filter.return_value.filter.return_value.scalar.return_value
    ) = 1000
