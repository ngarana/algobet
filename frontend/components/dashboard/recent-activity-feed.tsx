...
export function RecentActivityFeed({ activities: propActivities, isLoading = false }: RecentActivityFeedProps) {
    ...
    <div className="space-y-3">
      {activities.map((activity) => (
        <div key={activity.id} className="flex items-start gap-3">
          <div className={`h-2 w-2 rounded-full mt-1.5 ${activity.color}`}></div>
