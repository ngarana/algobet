...
import type { Match, MatchDetail, MatchFilters, PaginatedResponse } from '@/lib/types/api'
import { MatchSchema, MatchDetailSchema, createPaginatedResponseSchema } from '@/lib/types/schemas'

const matchArraySchema = createPaginatedResponseSchema(MatchSchema)
const matchDetailSchema = MatchDetailSchema

export async function getMatches(filters?: MatchFilters): Promise<PaginatedResponse<Match>> {
