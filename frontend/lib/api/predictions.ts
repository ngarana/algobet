...
export async function getPredictions(filters?: PredictionFilters): Promise<PaginatedResponse<Prediction>> {
...
export async function getUpcomingPredictions(daysAhead?: number): Promise<PaginatedResponse<Prediction>> {
